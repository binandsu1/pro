...
@section('content')
    ...
    <section class="content">
        <div class="box box-solid">
            ...
            <div class="no-padding box-body table-responsive" style="overflow: auto; width: 100%;">
                <table class="table table-bordered table-hover table-striped" style="width:1500px;">
                    ...
                    @foreach($list as $item)
                        <tr>
                            ...
                            <td title="{{$item->address}}">  {{ str_limit(trim($item->address), 136, '...')}} </td>
                            <td class="tcc ">
